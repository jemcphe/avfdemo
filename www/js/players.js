...
var starterValue = "No";
var errMsg = $("errors");
var addNewLink = $("addNew");

function onDeviceReady() {
    navigator.notification.alert("Hello, This is to prove that the Native Notification features are working!",
                                 alertDismissed,
                                 "iDraft",
                                 "Yesss!!");
...
function makeItemLinks(key, linksLi) {
    ...
    editLink.setAttribute("class", "buttons");
    editLink.key = key;
...
//    linksLi.appendChild(breakTag);
    ...
    deleteLink.setAttribute("class", "buttons");
    deleteLink.key = key;
...
addNewLink.addEventListener("click", addNewBtn);
